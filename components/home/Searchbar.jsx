  ...
  return (
    <div >
      <div className=" relative items-center flex justify-center  lg:mr-10 cursor-pointer">
        ...
        />
        <button className="bg-black text-white right-3 hidden sm:block absolute p-3 xl:scale-125  xl:right-6 rounded-full" name="search">
          <svg
        ...
        <button className="bg-[#242f40] text-white sm:hidden right-2 xs-max:right-3 absolute p-2 rounded-full   " name="search">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            x="0px"
            y="0px"
