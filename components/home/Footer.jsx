    ...
    return (
        <footer className=" body-font shadow-xl bg-white  border-t-2 border-black ">
            <ToastContainer
                ...
                theme="light"
            />
            <div className="max-w-[1300px]  level2:container   px-5 py-5 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap justify-between flex-wrap flex-col">
                <div >
                    ...
                    <form onSubmit={()=>submitHandler} className="sm:flex items-center gap-2  mt-3">
                        <div className="flex justify-center">
                            <input type="email" value={email} onChange={()=>changeHandler} name="email" id="email" placeholder="Enter your email" className="w-full max-w-[400px] rounded border-[1.7px] border-black  focus:outline-none focus:border-indigo-500 text-base mb-2 md:mb-0 level4:mb-0 px-4 py-2" />
                        </div>
                        <div className="flex justify-center">
                ...
                <div className="text-center sm:text-start my-2 mt-4" >
                    ...
                    <ul className="font-mono">
                        <li>
                            <Link className="text-black hover:text-gray-400" href="/login">Login</Link>
                        </li>
                        <li>
                            <Link className="text-black hover:text-gray-400" href="/signup">Sign up</Link>
                        </li>
                        {/* <li>
                            <Link className="text-black hover:text-gray-400" href="/trackorder">Track Order</Link>
                        </li> */}
                ...
                <div className="text-center sm:text-start my-2" >
                    ...
                    <ul className="font-mono">
                        ...
                        <li>
                            <Link className="text-black hover:text-gray-400" href="/contact">Contact Us</Link>
                        </li>
                        <li>
                ...
                <div className="text-center sm:text-start my-2" >
                    ...
                    <ul className="font-mono">
                        <li>
                            <Link className="text-black hover:text-gray-400" href="/privacy_policy">Privacy Policy</Link>
                        </li>
                        <li>
                            <Link className="text-black hover:text-gray-400" href="/terms_and_condition">Terms and Conditions</Link>
                        </li>
                        <li>
                            <Link className="text-black hover:text-gray-400" href="/refund_policy">Refund/Return Policy</Link>
                        </li>
            ...
            <div className="border-t-2  border-b-2 border-black bg-black text-white">
                <div className="container mx-auto max-w-[1300px] pt-4 px-5 flex flex-wrap w-full flex-col sm:flex-row justify-between items-center level4:items-start level4:justify-between">
                    <div>
                        <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start items-center gap-3">
                            <Link className="text-black hover:text-gray-400" href="https://www.facebook.com/">
                            ...
                            <Link className="text-black hover:text-gray-400" href="https://twitter.com/">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                    width="36" height="36"
                                    className="fill-current text-white"
                                    viewBox="0 0 16 16">
                            ...
                            <Link className="text-black hover:text-gray-400" href="https://www.instagram.com/">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                    width="36" height="36"
                                    className="fill-current text-white"
                                    viewBox="0 0 16 16">
                            ...
                            <Link className="text-black hover:text-gray-400" href="https://www.youtube.com/">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                    width="36" height="36"
                                    className="fill-current text-white"
                                    viewBox="0 0 16 16">
                ...
                <div className="container mx-auto py-4 px-5 flex max-w-[1300px] flex-wrap flex-col sm:flex-row justify-between text-white">
                    <p className="text-white text-sm text-center sm:text-left">
                        © 2023 mathsloyal.com —
                        <Link  className=" ml-1 text-white" href="https://twitter.com/">
                            @mathsloyal
                       </Link>
                    </p>
        ...
        //             <ul className="font-mono">
        //                 <li>
        //                    <Link className="text-black hover:text-gray-400" href=""><a className="text-white hover:text-gray-400">Login</Link>
        //                 </li>
        //                 <li>
        //                    <Link className="text-black hover:text-gray-400" href=""><a className="text-white hover:text-gray-400">Sign up</Link>
        //                 </li>
        //                 <li>
        //                    <Link className="text-black hover:text-gray-400" href=""><a className="text-white hover:text-gray-400">Track Order</Link>
        //                 </li>
        ...
        //             <ul className="font-mono">
        //                 <li>
        //                    <Link className="text-black hover:text-gray-400" href=""><a className="text-white hover:text-gray-400">About Us</Link>
        //                 </li>
        //                 <li>
        //                    <Link className="text-black hover:text-gray-400" href=""><a className="text-white hover:text-gray-400">Contact Us</Link>
        //                 </li>
        //                 <li>
        //                    <Link className="text-black hover:text-gray-400" href=""><a className="text-white hover:text-gray-400">FAQs</Link>
        //                 </li>
        ...
        //             <ul className="font-mono">
        //                 <li>
        //                    <Link className="text-black hover:text-gray-400" href=""><a className="text-white hover:text-gray-400">Privacy Policy</Link>
        //                 </li>
        //                 <li>
        //                    <Link className="text-black hover:text-gray-400" href=""><a className="text-white hover:text-gray-400">Terms and Conditions</Link>
        //                 </li>
        //                 <li>
        //                    <Link className="text-black hover:text-gray-400" href=""><a className="text-white hover:text-gray-400">Return Policy</Link>
        //                 </li>
        ...
        //             <div>
        //                 <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start items-center gap-3">
        //                    <Link className="text-black hover:text-gray-400" href="">
        //                         <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
        //                             width="36" height="36"
