...
export const Leftbar = ({ ask, setAsk, setChat, chat, setStudent, Question, Questions }) => {
  ...
  useEffect(() => {
    if (router.pathname === '/user') {
      ...
      setActive('ai')
      handleNavDrop(true);
    } else if (router.pathname === '/user/plans') {
      setActive('plans')
      handleNavDrop(true);
    }
  }, [router.pathname])
  return (
    <div>
      ...
      <div className="w-max hidden bg-white  border-r shadow-md   min-h-screen h-full relative  md:grid grid-cols-1 px-2 pt-5">
        ...
        <div className="flex flex-col relative  bg-white text-center mb-1 ">
          <div className="grid grid-cols-1 gap-8">
            ...
            <div
              className={`grid grid-cols-1 w-max mx-auto px-2 py-1 cursor-pointer  ${active === "ai"
                ? "bg-gray-200 rounded-lg "
                : "hover:bg-gray-100"
                }`}
            ...
            >
              ...
              <img src="/icons/chatbot.webp" alt="" className='w-[35px]' />
            ...
            <div
              className={`grid grid-cols-1 w-max mx-auto px-2 py-1 cursor-pointer  ${active === "plans"
                ? "bg-gray-200 rounded-lg "
                : "hover:bg-gray-100"
                }`}
            ...
            >
              ...
              <img src="/icons/pricing.webp" alt="" className='w-[35px]' />
