...
<div className='w-full md:flex gap-10 md:w-[90%]'>
        <Image src="/Ques.webp" width={350} height={460} className='shadow-xl w-[250px] mx-auto md:ml-20'/>
        <div className=''>
...
<div className='w-full md:flex md:w-[90%] gap-10 md:pt-20 mt-14'>
        <div className='hidden md:flex'>
          ...
          <Image src="/Solu.webp" width={350} height={460} className='shadow-xl w-[250px] mx-auto md:ml-20' />
