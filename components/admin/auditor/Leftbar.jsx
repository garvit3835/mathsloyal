...
export const Leftbar = ({ ask, setAsk, setChat, chat }) => {
    ...
    useEffect(() => {
        if (router.pathname === '/admin/auditor') {
            setActive('overview')
            handleNavDrop(false)
        }
        else if (router.pathname === '/admin/auditor/student') {
            setActive('student')
            handleNavDrop(false);

        }
        else if (router.pathname === '/admin/auditor/tutor') {
            setActive('tutor')
            handleNavDrop(false);

        }
        else if (router.pathname === '/admin/auditor/auditor') {
            setActive('auditor')
            handleNavDrop(false);
        ...
        <div>
            <div>
                <div className="h-[50px] z-20 flex bg-white shadow-lg items-center  px-5 md:hidden fixed top-0 w-screen">
                    ...
                    <Link href='/admin/auditor' className="text-2xl text-blue-700 text-center w-full ">ML</Link>
                </div>
                <div
      ...
      ${navDrop ? "-translate-x-[150%]" : "translate-x-[0px]"
                ...
                >
                    ...
                    <div className=' m-2 mb-0  rounded-lg grid grid-cols-1 gap-2 text-start px-5 '>
                        ...
                        <Link href="/admin/auditor/student">
                            <div className="text-lg  ">Student</div>
                        </Link>
                        <Link href="/admin/auditor/tutor">
                            <div className="text-lg t ">Tutor</div>
                        </Link>
                        <Link href="/admin/auditor/auditor">
                            <div className="text-lg te ">Auditor</div>
                        </Link>
                        <div onClick={() => {
                            localStorage.removeItem("myauditorToken")
                            router.push("/admin/auditor/login")
                        }}>
                ...
                <div className="flex flex-col text-center mb-10 ">
                    <div className="grid grid-cols-1 gap-8">
                        <div
                            ...
                            onClick={() => router.push("/admin/auditor")}
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                x="0px"
                        ...
                        <div
                            ...
                            onClick={() => router.push("/admin/auditor/tutor")}
                        >
...
<img src="/icons/tutor.webp" alt=""  className='w-[38px] '/>
                        ...
                        <div
                            ...
                            onClick={() => router.push("/admin/auditor/student")}
        >
                        ...
                        {/* <div
                            ...
                            onClick={() => router.push("/admin/auditor/auditor")}
                        >
