...
const ProfilePreview = () => {
  return (
    <div className="flex border bg-white rounded-2xl p-8 m-5 shadow-lg  ">
      <div className="w-2/5 items-center flex justify-center">
        <div>
          ...
          <div className="text-2xl font-semibold mt-2  w-max mx-auto">Junaid</div>
        </div>
      </div>
      ...
      <div className="w-3/5 ">
        <div className="grid grid-cols-2 w-full mb-4">
          <div className="">
            ...
            <div className="text-lg font-semibold">12th</div>
          </div>
          <div className="">
            <div className="text-[10px]">Board</div>
            <div className="text-lg font-semibold">CBSE</div>
          </div>
        </div>
         <div className="grid grid-cols-2 w-full">
        <div className="">
          <div className="text-[10px]">Target</div>
          <div className="text-lg font-semibold">JEE MAINS</div>
        </div>
        <div className="">
