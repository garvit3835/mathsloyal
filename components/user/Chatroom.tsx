...
const Chatroom = () => {
  return (
    <div className=" top-0 h-screen   transition-width flex flex-col  overflow-hidden i flex-1">
      <div className="    pr-40 overflow-hidden h-full d">
        <div className=" w-full     ">
          <div className="flex justify-end w-full ml-[150px] ">
